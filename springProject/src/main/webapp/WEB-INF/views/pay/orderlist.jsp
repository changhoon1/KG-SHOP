...
<!-- Navigation -->
  ...
  <h1 style="text-align: center; padding-top: 30px;">주문내역</h1>
<table class="table" style="margin-top: 20px;">
<c:forEach items="${orderlist}" var="orderlist">
   <tr>
      <th>아이디</th><th>이메일</th><th>주소</th><th>번 호 </th><th>상품명 </th><th>가 격</th><th>수 량</th><th>총 가 격</th>  <th></th>    
   </tr>
   <tr>
      <td>${orderlist.id }</td>
      ...
      <td>${orderlist.tel }</td>
      <td> ${orderlist.product_name_title }</td>
      <td>${orderlist.product_name_price }</td>
      <td>${orderlist.product_count }</td>
      <td>${orderlist.product_sumprice }</td>
      <td><a href="reviewWrite?product_name_title=${orderlist.product_name_title }">리뷰 쓰기</a></td>
   </tr>
</c:forEach>
</table>
